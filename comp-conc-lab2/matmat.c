...
int main(int argc, char* argv[]) {
   ...
   double inicio, fim, inicializacao, multiplicacao, finalizacao, total;
   ...
   free(tid);
   GET_TIME(fim)   
   finalizacao = fim - inicio;
   printf("Tempo finalizacao:%lf\n", finalizacao);
   total = inicializacao + multiplicacao + finalizacao;
